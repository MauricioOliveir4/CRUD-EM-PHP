...
<form action="usuario_form.php" method="POST" id="form1">
	...
	<table border='1' width="400">
		<input type="hidden" name="acao" id="acao" value="<?echo $acao;?>">
...
?>
		...
		<tr>
			<td><b>Nome</b></td>
			<td><input type="text" name="ednome" id="ednome" value="<?echo $nome;?>"required></td>
		</tr>
		<tr>
			<td><b>Email</b></td>
			<td><input type="text" name="edemail" id="edemail" value="<?echo $email;?>" required></td>
		</tr>
